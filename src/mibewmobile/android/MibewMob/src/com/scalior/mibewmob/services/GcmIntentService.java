...
import com.scalior.mibewmob.GcmBroadcastReceiver;
...
public class GcmIntentService extends IntentService {
    ...
    protected void onHandleIntent(Intent intent) {
        ...
        if (!extras.isEmpty()) {  // has effect of unparcelling Bundle
			MibewMobLogger.Log("Extras: " + extras.toString());
            ...
            // If it's a regular GCM message, do some work.
            	...
            	if (extras.getString("newvisitors").equals("1")) {
    				m_pollingServiceBinder.doCheckForActiveVisitors(extras.getString("oprtoken"));
            	}
            }
        }
